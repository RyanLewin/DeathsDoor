...
public static class Noise
{
    ...
    public static int hashCount = 255;
    ...
    public static float Value1D (Vector3 point, float frequency = 1)
    {
        point *= frequency;
        ...
        t = Smooth(t);
        return Mathf.Lerp(h0, h1, t) * (1f / hashCount);
    }

    public static float Value2D (Vector3 point, float frequency = 1)
    {
        point *= frequency;
